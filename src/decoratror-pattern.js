...
var RefacingSeats = /** @class */ (function (_super) {
    __extends(RefacingSeats, _super);
    function RefacingSeats(car) {
        var _this = _super.call(this) || this;
        _this.decoratedCar = car;
        return _this;
    }
    RefacingSeats.prototype.getDescription = function () {
        return this.decoratedCar.getDescription() + ', Refacing Seats';
    };
    RefacingSeats.prototype.cost = function () {
        return this.decoratedCar.cost() + 400;
    };
    return RefacingSeats;
}(CarOptions));
